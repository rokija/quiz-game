...
import { API, GET_RESULTS_SUCCESS, GET_RESULTS_ERROR, GET_QUIZZES_SUCCESS, GET_QUIZZES_ERROR, 
        GET_MYQUIZZES_SUCCESS, GET_MYQUIZZES_ERROR ,
        GET_RECORDS_ERROR, GET_RECORDS_SUCCESS} from "../../constants";
